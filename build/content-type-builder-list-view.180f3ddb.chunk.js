"use strict";(self.webpackChunkstrapi_project=self.webpackChunkstrapi_project||[]).push([[5905],{57134:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>lt});var e=n(67294),r=n(5458),$=n(96315),W=n(85018),K=n(4585),X=n(67109),D=n(53979),m=n(11047),R=n(29728),L=n(49066),g=n(41580),V=n(27361),l=n.n(V),f=n(18721),x=n.n(f),b=n(18446),C=n.n(b),P=n(11700),N=n.n(P),I=n(86896),J=n(16550),q=n(45697),o=n.n(q),ge=n(38939),fe=n(8060),he=n(79031),_=n(37909),T=n(75515),Pe=n(49386),ye=n(26478),H=n(13588),Z=n(88972),v=n(5002),ke=n(70968),Be=n(52624),Ee=n(44915);function ae({isActive:t,icon:a}){return e.createElement(m.k,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%"},e.createElement(Be.J,{as:Ee.c[a]||Ee.c.cube,height:5,width:5}))}ae.defaultProps={isActive:!1,icon:"Cube"},ae.propTypes={isActive:o().bool,icon:o().string};const be=(0,Z.ZP)(g.x)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,r.Q1)(8)};
...
`;function re({component:t,dzName:a,index:i,isActive:s,isInDevelopmentMode:p,onClick:d}){const{modifiedData:h,removeComponentFromDynamicZone:k}=(0,H.Z)(),{schema:{icon:j,displayName:M}}=l()(h,["components",t],{schema:{}}),y=c=>{c.stopPropagation(),k(a,i)};return e.createElement(Ae,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:d,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${a}-panel-${i}`,id:`dz-${a}-tab-${i}`},e.createElement(ae,{icon:j,isActive:s}),e.createElement(g.x,{marginTop:1,maxWidth:"100%"},e.createElement(T.Z,{variant:"pi",fontWeight:"bold",ellipsis:!0},M)),p&&e.createElement(be,{as:"button",onClick:y},e.createElement(ke.Z,null)))}re.defaultProps={component:null,isActive:!1,isInDevelopmentMode:!1,onClick(){}},re.propTypes={component:o().string,dzName:o().string.isRequired,index:o().number.isRequired,isActive:o().bool,isInDevelopmentMode:o().bool,onClick:o().func};const Ie=re,ve=Z.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
